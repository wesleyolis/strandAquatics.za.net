...
<td height="25" width="175">&nbsp;</td></tr>
<tr><td height="25" colspan="2">Mobile link: http://www.strandaquatics.za.net/mobile/time.asp?a=<%=Request.QueryString("Athlete")%></td>
</tr></table><%
rs.Close();
...
<!--
alert("Did you know..\n\nYou can now access your times on a cell phone\nIt's quick and easy vist: http://www.strandaquatics.za.net/mobile/\n\nBookmark this link to vist this page directly:\nMobile link: http://www.strandaquatics.za.net/mobile/time.asp?a=<%=Request.QueryString("Athlete")%>");
//-->
</script>
...
<%}  %></table><%rs.close();
oConn.close();}%></td></tr></table><p>&nbsp;</p></body></html>
<%
}
%>