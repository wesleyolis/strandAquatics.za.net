...
"western_province/secure/Sw" + Request.Form("TMV") + "Bkup" + Request.Form("DBName") + "-" + Request.Form("Version") + ".zip"

if(fs.FileExists(webdir + "western_province/secure/Sw" + Request.Form("TMV") + "Bkup" + Request.Form("DBName") + "-" + Request.Form("Version") + ".zip"))
{
%>
...
<table border="0" width="641" id="table3" cellspacing="0" cellpadding="0" height="190">
	...
	<tr>
		...
		<form name="up" style="color: #000990; font-weight: bold">
			...
			<tr>
				<td width="249">Updating Time Display on Menu</td>
				<td> 
				<input type="text" name="TDis" size="45" style="border-style:solid; border-width:0; background-color: #4698D3; color:#000990; font-weight:bold"></td>
			</tr>
			<tr>
...
Server.Execute("Update_Site_Time.asp");
...
<br>
<br>
<font size='5' color="#FF0000">Database file doesn't Exist</font>
<br>
<br>
<a href="default.asp">Click here to try again</a>
</p>
<%}
fs = null;
}
