...
function g(url)
{parent.location=("meet.asp?Meet=<%=Request.QueryString("Meet")%>&MtEvent=" + url+ "&MName=" + MName );}
function o(row)
...
<tr style="color: #000080; font-weight: bold" >
	...
	<a href="../points.asp?Meet=<%=Request.QueryString("Meet")%>&MName=<%=Request.QueryString("MName")%>&Gender=F">
	Female Points</a>
	</td><td   colspan="4"  align="center" >
	<a href="../points.asp?Meet=<%=Request.QueryString("Meet")%>&MName=<%=Request.QueryString("MName")%>&Gender=M">
	Male Points</a>
	</td></tr>
...
<table border="0" cellpadding="0" cellspacing="0" width="799" id="table1">
	...
	<tr><td align="center">
		...
		<img border="2" src="photos/<%=rs2("MEvent")%>.jpg" width="491" height="264"></a></td></tr>
		<%}%>
	<tr><td align="center">
...
<td><a onmouseover="disath(<%=rs.Fields("Athlete")%>)" href='javascript:r(<%=rs.Fields("Athlete")%>)'><%=rs.Fields("Last")%>, &nbsp;<%=rs.Fields("First")%></a></td>
<td><%=rs.Fields("Sex")%></td>
<td><%=rs.Fields("Age")%></td>
