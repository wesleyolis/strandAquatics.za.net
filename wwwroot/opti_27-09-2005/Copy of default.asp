...
</v:shapetype><v:shape id="_x0000_s1042" type="#_x0000_t136" alt="*" style='width:37.5pt;
...
src="default_files/image001.gif" alt="*" v:shapes="_x0000_s1042"><![endif]></td>
		<td>
		<p align="center"><!--[if gte vml 1]><v:shape
 id="_x0000_s1041" type="#_x0000_t136" alt="Strand Aquatics Swimming" style='width:309.75pt;
...
src="default_files/image002.gif" alt="Strand Aquatics Swimming" v:shapes="_x0000_s1041"><![endif]></td>
		<td id="star2" width="62" align="center" style="display:none;"><!--[if gte vml 1]><v:shape
 id="_x0000_s1040" type="#_x0000_t136" alt="*" style='width:37.5pt;height:34.5pt'
...
src="default_files/image001.gif" alt="*" v:shapes="_x0000_s1040"><![endif]></td>
	</tr>
</table>
<table style="position: absolute; left: 190px; top: 0px; width: 502px; height: 57px; z-index: 1" border="0" id="Strand1" cellspacing="0" cellpadding="0">
 ...
 id="_x0000_s1039" type="#_x0000_t136" alt="Strand Aquatics Swimming" style='width:375pt;
...
src="default_files/image003.gif" alt="Strand Aquatics Swimming" v:shapes="_x0000_s1039"><![endif]></td>
	</tr>
</table>
...
height=44 src="default_files/image004.gif" alt="Designed&#13;&#10;by&#13;&#10;WIP"
...
height=36 src="default_files/image005.gif" alt=WIP v:shapes="_x0000_s1037"></span><![endif]><!--[if gte vml 1]><v:shape
...
height=29 src="default_files/image006.gif" alt=by v:shapes="_x0000_s1034"></span><![endif]></td></tr><tr>
		<td align='center' valign='top' width="556">
<p></p>
<table border="1" width="100%" id="table2" height="323" cellspacing="1" cellpadding="4" bordercolor="#0066CC">
	<tr>
		<td width="100%" align="center" height="122" valign="top" colspan="2">
		<b><font size="5">Welcome once again..</font></b><p><b>We would just 
		like to apologies for the crashing of the Meet Report Filters,<br>
		Unfortunately it only came to my attention, yesterday 15 Aug.<br><u>It 
		is now fixed and working,</u> please let us know if any pages do crash,<br>
		thus we are then able to fix then ASAP,<br>Please in club the URL 
		(adress in your email to which page)</b></p>
		<p>**<a href="meets/meet_report.asp">Try 
		out our new Meet Reports Filters and let us know what u think click here</a>**</td>
	</tr>
	<tr>
		<td align="center" height="170" valign="top" width="50%">
		<table border="0" cellpadding="0" cellspacing="0" id="table19" width="236" height="263">
			<tr>
				<td align="center" height="33"><b><font size="5" face="Broadway">Site Fix's</font></b></td>
			</tr>
			<tr>
				<td height="5"></td>
			</tr>
			<tr>
				...
				<table border="0" cellpadding="0" cellspacing="0" width="235" id="table21">
					<tr>
						<td>
						<ul>
							<li>Meet Results, click on athlete, to view times. 
							no page error.</li>
							<li>Meet Report, Filter selected teams only. </li>
							<li>Meet Results: View all, Report increased 
							compression of page data <b>(downloads much faster)</b>.</li>
						</ul>
						</td>
					</tr>
				</table>
				<b>New Site Admin </b><br>E-mail:<a href="mailto:14544830@sun.ac.za?subject=strandaquatics: ">14544830@sun.ac.za</a></td>
			</tr>
			<tr>
				<td align="center"><u>Ideas, or suggestions are welcome. </u></td>
			</tr>
		</table>
		</td>
		<td align="center" height="170" valign="top" width="50%">
 ...
 id="_x0000_s1038" type="#_x0000_t136" alt="W.P Rankings"
 href="times.asp?Province=WP" style='width:190.5pt;height:37.5pt' fillcolor="#f06">
 <v:shadow on="t" opacity="52429f"/>
 <v:textpath style='font-family:"Arial Black";v-text-kern:t' trim="t"
  fitpath="t" string="Time Standards"/>
</v:shape><![endif]--><![if !vml]><span style='mso-ignore:vglayout'><map
name=MicrosoftOfficeMap0><area shape=Polygon
coords="0, 2, 0, 15, 5, 18, 5, 53, 14, 54, 71, 54, 251, 54, 252, 54, 257, 51, 258, 41, 257, 24, 254, 18, 237, 2, 0, 2"
href="times.asp?Province=WP" title=""></map><img border=0 width=258 height=55
src="default_files/image007.gif" usemap="#MicrosoftOfficeMap0"
alt="W.P Rankings" v:shapes="_x0000_s1038"></span><![endif]></tr>
			<tr>
				<td height="5">
				</td>
			</tr>
			<tr>
				<td align="center"><b><font size="3">These are Times where by you 
				can judge yourself, in the big world swimming and set goals for 
				your self </font></b>
				<table style="FONT-WEIGHT: bold" cellSpacing="0" cellPadding="0" width="291" border="0" id="table20">
					<tr>
						<td width="90">USA</td>
						<td>USA Swimming National</td>
						<td width="36">2003</td>
					</tr>
					<tr>
						<td width="90">USS</td>
						<td>Motivational Standard</td>
						<td width="36">2005</td>
					</tr>
					<tr>
						<td width="90">USS16</td>
						<td>USS Top 16</td>
						<td width="36">2005</td>
					</tr>
					<tr>
						<td width="90">WPLEAGUE</td>
						<td>League Galas</td>
						<td width="36">2006</td>
					</tr>
				</table>
				<b><font color="#000990"><a href="times.asp?Province=WP">How to 
				use time standards, Please go to athlete time's select the 
				athlete then click on Time standards</a></font></b></td>
			</tr>
		</table>
		</td>
	</tr>
...
<table border="0" cellpadding="0" cellspacing="0" width="268" id="table22">
	<tr>
		<td align="center" bgcolor="#FF9999" bordercolor="#000000" style="border-style: solid; border-width: 1px; padding-left: 4px; padding-right: 4px; padding-top: 1px; padding-bottom: 1px">
		<b><font size="4">GPRS, WAB (CELL, PDA)</font></b></td>
	</tr>
	<tr>
		<td height=10px> </td>
	</tr>
	<tr>
		<td height="37">If your one who like to do things from there, Cell or 
		PDA, then this would be for you.<p>Let us know, what you would like 
		access to, such as athlete times, meet results (suggest). Please 
		remember that these are limited.</p>
		<p align="center">
		<a href="mailto:minibrowser@strandaquatics.za.net?subject=strandaquatics: GRPS-WAB">
		Click here if you want it</a></td>
	</tr>
</table>
		</td></tr><tr>
...
<table class="menu" id="table17" style="display: block; border-collapse: collapse; padding-left: 3px; font-size:10pt; font-family:Times New Roman; font-weight:bold" borderColor="#000080" cellSpacing="0" cellPadding="0" width="647" border="2">
	...
	<td id="i1m06" onmouseover="o('1m0',6)" onclick="parent.self.location.replace('qt/index.htm');" onmouseout="t('1m0',6)" nowrap><a href="qt/index.htm">
		<font color="#000080">Qualifying Times </font>
	</a></td>
	</tr>
	</table>
			</td>
