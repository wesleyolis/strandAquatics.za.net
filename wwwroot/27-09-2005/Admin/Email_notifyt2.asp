...
JMail.Sender = "strandaqua@telkomsa.net";
JMail.Subject = "Swimming Results Notification";
JMail.AddRecipientEx(oRs.Fields("EMail") , oRs.Fields("Name") + ", " + oRs.Fields("Surname"));
JMail.ReplyTo = "";
s = "";
s +="<HTML>";
s +="<HEAD>";
...
s +="<a href='http://www.strandaquatics.za.net/unsubscribe.asp?Email=" + oRs.Fields("EMail") + "'>Click Here to ";
