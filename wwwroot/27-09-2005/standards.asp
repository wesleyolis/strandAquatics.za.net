...
Response.Redirect("standards.asp?standardFile=" + recFile + "&STDDes=" + Request.QueryString("STDDes"));
...
<%=(":" + "SELECT Sex, Distance, Stroke, I_R" + query + " FROM [" + Request.QueryString("standardFile")  + "] WHERE ((Lo_Age = " + Request.QueryString("Lo") + ") And ( Hi_age =" + Request.QueryString("Hi") + ")) ORDER BY Sex,I_R,Stroke,Distance")%>
