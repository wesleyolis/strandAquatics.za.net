...
+" FROM (SELECT RESULT.MEET,RESULT.F_P, RESULT.STROKE, RESULT.DISTANCE,RESULT.SCORE FROM RESULT WHERE (((RESULT.ATHLETE)="+Athlete+") AND ((RESULT.COURSE)='" + Course + "'))) AS rs, (SELECT [" + StdFile + "].* FROM [" + StdFile + "], Athlete"
