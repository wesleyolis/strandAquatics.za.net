...
var Course,Lo,Hi,Gender,Province,Page;
...
<%}else{if(Request.QueryString("Course").count==0 || Course == "" || Request.QueryString("Gender").count==0 || Gender == ""){%>
<html>
<head>
<meta http-equiv="Content-Language" content="en-za">
<meta http-equiv="Content-Type" content="text/html; charset=windows-1252">
...
<tr><td width="176"><a href="points.asp?Province=<%=Province%>&Course=<%=Course%>&Gender=<%=Gender%>&Lo=0&Hi=99&Page=1">Open&nbsp; (all ages)</a></td>
<td width="124"><a href="points.asp?Province=<%=Province%>&Course=<%=Course%>&Gender=<%=Gender%>&Lo=19&Hi=19&Page=1">19 yrs</a></td></tr>
<tr><td><a href="points.asp?Province=<%=Province%>&Course=<%=Course%>&Gender=<%=Gender%>&Lo=21&Hi=99&Page=1">21 &amp; Over</a></td><td>
<a href="points.asp?Province=<%=Province%>&Course=<%=Course%>&Gender=<%=Gender%>&Lo=18&Hi=18&Page=1">18 yrs</a></td></tr>
<tr><td><a href="points.asp?Province=<%=Province%>&Course=<%=Course%>&Gender=<%=Gender%>&Lo=18&Hi=21&Page=1">18 - 21</a></td><td>
<a href="points.asp?Province=<%=Province%>&Course=<%=Course%>&Gender=<%=Gender%>&Lo=17&Hi=17&Page=1">17 yrs</a></td></tr>
<tr><td><a href="points.asp?Province=<%=Province%>&Course=<%=Course%>&Gender=<%=Gender%>&Lo=19&Hi=99&Page=1">19 &amp; over</a></td><td>
<a href="points.asp?Province=<%=Province%>&Course=<%=Course%>&Gender=<%=Gender%>&Lo=16&Hi=16&Page=1">16 yrs </a> </td></tr>
<tr><td><a href="points.asp?Province=<%=Province%>&Course=<%=Course%>&Gender=<%=Gender%>&Lo=17&Hi=18&Page=1">17 - 18</a></td><td>
<a href="points.asp?Province=<%=Province%>&Course=<%=Course%>&Gender=<%=Gender%>&Lo=15&Hi=15&Page=1">15 yrs </a> </td></tr>
<tr><td><a href="points.asp?Province=<%=Province%>&Course=<%=Course%>&Gender=<%=Gender%>&Lo=17&Hi=99&Page=1">17 &amp; Over</a></td><td>
<a href="points.asp?Province=<%=Province%>&Course=<%=Course%>&Gender=<%=Gender%>&Lo=14&Hi=14&Page=1">14 yrs </a> </td></tr>
<tr><td><a href="points.asp?Province=<%=Province%>&Course=<%=Course%>&Gender=<%=Gender%>&Lo=16&Hi=17&Page=1">16-17</a></td><td>
<a href="points.asp?Province=<%=Province%>&Course=<%=Course%>&Gender=<%=Gender%>&Lo=13&Hi=13&Page=1">13 yrs </a> </td></tr>
<tr><td><a href="points.asp?Province=<%=Province%>&Course=<%=Course%>&Gender=<%=Gender%>&Lo=15&Hi=18&Page=1">15 - 18</a></td>
<td><a href="points.asp?Province=<%=Province%>&Course=<%=Course%>&Gender=<%=Gender%>&Lo=12&Hi=12&Page=1">12 yrs</font></a></td></tr>
<tr><td><a href="points.asp?Province=<%=Province%>&Course=<%=Course%>&Gender=<%=Gender%>&Lo=15&Hi=16&Page=1">15-16</a></td><td>
<a href="points.asp?Province=<%=Province%>&Course=<%=Course%>&Gender=<%=Gender%>&Lo=0&Hi=12&Page=1">12 &amp; under</a></td></tr>
<tr><td><a href="points.asp?Province=<%=Province%>&Course=<%=Course%>&Gender=<%=Gender%>&Lo=15&Hi=99&Page=1">15 &amp; Over</a></td><td>
<a href="points.asp?Province=<%=Province%>&Course=<%=Course%>&Gender=<%=Gender%>&Lo=11&Hi=11&Page=1">11 yrs</a></td></tr>
<tr><td><a href="points.asp?Province=<%=Province%>&Course=<%=Course%>&Gender=<%=Gender%>&Lo=13&Hi=14&Page=1">13 - 14</a></td><td>
<a href="points.asp?Province=<%=Province%>&Course=<%=Course%>&Gender=<%=Gender%>&Lo=10&Hi=10&Page=1">10 yrs</a></td></tr>
<tr><td><a href="points.asp?Province=<%=Province%>&Course=<%=Course%>&Gender=<%=Gender%>&Lo=13&Hi=16&Page=1">13 - 16</a></td><td>
<a href="points.asp?Province=<%=Province%>&Course=<%=Course%>&Gender=<%=Gender%>&Lo=0&Hi=10&Page=1">10 &amp; under</a></td></tr>
<tr><td><a href="points.asp?Province=<%=Province%>&Course=<%=Course%>&Gender=<%=Gender%>&Lo=11&Hi=12&Page=1">11- 12</a></td>
<td><a href="points.asp?Province=<%=Province%>&Course=<%=Course%>&Gender=<%=Gender%>&Lo=9&Hi=9&Page=1">9 yrs </a> </td></tr>
<tr><td><a href="points.asp?Province=<%=Province%>&Course=<%=Course%>&Gender=<%=Gender%>&Lo=11&Hi=14&Page=1">11 -14</a></td>
<td><a href="points.asp?Province=<%=Province%>&Course=<%=Course%>&Gender=<%=Gender%>&Lo=0&Hi=8&Page=1">8 &amp; under</a> </td></tr>
</table><%}else{
if(true){
var oConn;	
	var rs;		
...
<p  align="right"><font size="2"><%=Date()%><br>Page Last Refreshed</font></p></div><%   rs.Close(); rs=null;oConn.Close();oConn=null;}}}}%>
