...
{gender = rs.Fields("Sex").Value;%><tr><td colspan ="7" algin="center" height="30" style="border-left-width: 1px; border-right-width: 1px; border-top-width: 1px; border-bottom-style: dashed; border-bottom-width: 1px;"><font color="#000080" size="3"><%if(rs.Fields("Sex") == "M"){%>Male<%}else{%>Female<%}%></font></td></tr>
